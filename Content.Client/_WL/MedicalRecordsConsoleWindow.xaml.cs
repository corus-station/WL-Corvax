...
public sealed partial class MedicalRecordsConsoleWindow : FancyWindow
{
    ...
    private const string ReasonPlaceholders = "medicalRecordsWantedReasonPlaceholders";
    ...
    private void PopulateRecordContainer(GeneralStationRecord stationRecord, MedicalRecord MedicalRecord)
    {
        ...
        {
            var message = FormattedMessage.FromMarkupOrThrow(Loc.GetString("medical-records-console-wanted-reason"));
